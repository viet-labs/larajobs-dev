...
use App\Http\Requests\Admin\ToChuc\ToChucStoreRequest;
use App\Http\Requests\Admin\ToChuc\ToChucUpdateRequest;
...
class ToChucController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('admin.to-chuc.index-company', compact('toChuc'))
            ->with('i', $value);
    }
    ...
    {
        return view('admin.to-chuc.create-company');
    }
    ...
    {
        return view('admin.to-chuc.show-company', compact('toChuc'));
    }
    ...
    {
        return view('admin.to-chuc.edit-company', compact('toChuc'));
    }
