...
use App\Http\Requests\Admin\CongViec\CongViecStoreRequest;
use App\Http\Requests\Admin\CongViec\CongViecUpdateRequest;
...
class CongViecController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('admin.cong-viec.index-work', compact('congViec'))
            ->with('i', $value);
    }
    ...
    {
        return view('admin.cong-viec.create-work');
    }
    ...
    {
        return view('admin.cong-viec.show-work', compact('congViec'));
    }
    ...
    {
        return view('admin.cong-viec.edit-work', compact('congViec'));
    }
