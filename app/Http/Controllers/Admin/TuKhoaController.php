...
use App\Http\Requests\Admin\TuKhoa\TuKhoaStoreRequest;
use App\Http\Requests\Admin\TuKhoa\TuKhoaUpdateRequest;
...
class TuKhoaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('admin.tu-khoa.index-tag', compact('tuKhoa'))
            ->with('i', $value);
    }
    ...
    {
        return view('admin.tu-khoa.create-tag');
    }
    ...
    {
        return view('admin.tu-khoa.show-tag', compact('tuKhoa'));
    }
    ...
    {
        return view('admin.tu-khoa.edit-tag', compact('tuKhoa'));
    }
